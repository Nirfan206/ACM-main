...
function CustomerCareProfile() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      console.error("❌ Failed to fetch Customer Care profile:", err);
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      console.error("❌ Failed to save Customer Care profile:", err);
  ...
  return (
    <div className="card profile-container">
      <h3 className="card-title text-center">👤 My Profile (Customer Care)</h3>
